...
for bat in ["molMol2", "myoMyo6"]:
    ...
    bat_genome_path = Path(PurePath(base_path, "Bat_genome", "results", "human_control", bat))

    signatures = [
        "APOBEC3A", "APOBEC3C", "APOBEC1"
    ]

    with open(PurePath(base_path, "human_control _"+bat+"_rums_apobec.csv"), "w") as f:
